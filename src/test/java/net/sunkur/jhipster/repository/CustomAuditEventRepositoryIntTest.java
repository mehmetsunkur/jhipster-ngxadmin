package net.sunkur.jhipster.repository;

import net.sunkur.jhipster.JhipsterApp;
import net.sunkur.jhipster.config.Constants;
import net.sunkur.jhipster.config.audit.AuditEventConverter;
import net.sunkur.jhipster.domain.PersistentAuditEvent;
...
import static net.sunkur.jhipster.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
