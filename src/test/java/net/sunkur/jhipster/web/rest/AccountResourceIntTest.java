...
import net.sunkur.jhipster.JhipsterApp;
import net.sunkur.jhipster.domain.Authority;
import net.sunkur.jhipster.domain.User;
import net.sunkur.jhipster.repository.AuthorityRepository;
...
import net.sunkur.jhipster.web.rest.errors.ExceptionTranslator;
import net.sunkur.jhipster.web.rest.vm.KeyAndPasswordVM;
