package net.sunkur.jhipster.config.social;

import net.sunkur.jhipster.repository.SocialUserConnectionRepository;
import net.sunkur.jhipster.repository.CustomSocialUsersConnectionRepository;
import net.sunkur.jhipster.security.jwt.TokenProvider;
import net.sunkur.jhipster.security.social.CustomSignInAdapter;
